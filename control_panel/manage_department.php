        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_department.php"><span class="mif-list2 icon"></span><span class="title">Manage Department</span></a></li>
            ...
            <div id="cell-content" class="pane-scroll cell auto-size padding30 pane-scroll">
                <h1 class="text-light">Manage Department</h1>
                <hr style="background-color:#493867;"><br>
                <div class="align-right">
                    <a class="button primary beautify beautify-mif" data-button="add-department-button" data-role="hint" data-hint="Add Department" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-plus"></span>&nbsp;&nbsp;Add</a>
                </div>
                <table id="department-table" class="table striped border bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $connection->fetch_assoc()) {
                                echo '<tr>';
                                echo '<td class="align-center">' . $row['Department_ID'] . '</td>';
                                echo '<td>' . $row['Department_Name'] . '</td>';
                                echo '<td class="align-center"><a class="button success mini-button beautify" data-button="edit-department-button" data-var-id="' . $row['Department_ID'] . '" data-role="hint" data-hint="Edit Department" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-pencil"></span></a><a class="button danger mini-button beautify" data-button="delete-department-button" data-var-id="' . $row['Department_ID'] . '" data-role="hint" data-hint="Delete Department" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-cross"></span></a></td>';
                                echo '</tr>';
                            }
...
<script src="assets/js/manage_department.js"></script>
