        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_weeding.php"><span class="mif-books icon"></span><span class="title">Book Weeding</span></a></li>
            ...
            <div id="cell-content" class="cell auto-size padding20 pane-scroll">
                <h1 class="text-light">Manage Weeded Books</h1>
                <hr style="background-color:#493867;"><br>
                <table id="weeding-table" class="table striped border bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            $connection->query("SELECT * FROM weeding INNER JOIN book ON weeding.Book_ID=book.Book_ID WHERE book.Status='inactive' GROUP BY book.Book_Title");
                            ...
                            while($row = $connection->fetch_assoc()) {
                                ...
                                echo '<td>' . $row['Date_Weeded'] . '</td>';
                                echo '<td>' . $row['Reason'] . '</td>';
                                echo '<td class="align-center"><a class="button primary mini-button beautify" data-button="restore-material-button" data-var-id="' . $row['Book_ID'] . '" data-role="hint" data-hint="Restore Book" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-loop2"></span></a></td>';
                                echo '</tr>';
                            }
...
<script src="assets/js/manage_weeding.js"></script>
