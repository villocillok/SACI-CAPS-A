<?php
    ...
    class PDF_Generate_Return_Report extends PDF_MC_Table {
        function Header() {
            ...
            if($this->PageNo() == 1) {
                ...
                $this->Cell(0, 5, 'Return Report', 0, 0, 'L');
            ...
            $this->Row(array('Return ID', 'Borrowers ID', 'Accession Number', 'Date Returned', 'Transaction Status', 'Official Receipt Number'));
