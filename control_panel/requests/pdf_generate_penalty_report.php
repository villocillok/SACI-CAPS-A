<?php
    ...
    class PDF_Generate_Penalty_Report extends PDF_MC_Table {
        function Header() {
            ...
            if($this->PageNo() == 1) {
                ...
                $this->Cell(0, 5, 'Penalty Report', 0, 0, 'L');
            ...
            $this->Row(array('Penalty ID', 'Return ID', 'Penalty', 'Date of Payment', 'Status'));
