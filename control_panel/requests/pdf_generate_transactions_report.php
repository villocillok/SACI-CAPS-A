<?php
    ...
    class PDF_Generate_Transactions_Report extends PDF_MC_Table {
        function Header() {
            ...
            if($this->PageNo() == 1) {
                ...
                $this->Cell(0, 5, 'Transactions Report', 0, 0, 'L');
                $this->Ln(20);
            }
            ...
            $this->Row(array('Borrower\'s Name', 'Borrowed Book', 'Date Borrowed', 'Due_Date', 'Date_Returned', 'Penalty', 'Status'));
