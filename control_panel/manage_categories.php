        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_categories.php"><span class="mif-list2 icon"></span><span class="title">Manage Categories</span></a></li>
            ...
            <div id="cell-content" class="pane-scroll cell auto-size padding20 pane-scroll">
                <h1 class="text-light">Manage Categories</h1>
                <hr style="background-color:#493867;"><br>
                <div class="align-right">
                    <a class="button primary beautify beautify-mif" data-button="add-category-button" data-role="hint" data-hint="Add Category" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-plus"></span>&nbsp;&nbsp;Add</a>
                </div>
                <table id="categories-table" class="table striped border bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $connection->fetch_assoc()) {
                                echo '<tr>';
                                echo '<td class="align-center">' . $row['Category_ID'] . '</td>';
                                echo '<td>' . $row['Category_Name'] . '</td>';
                                echo '<td class="align-center"><a class="button success mini-button beautify" data-button="edit-category-button" data-var-id="' . $row['Category_ID'] . '" data-role="hint" data-hint="Edit Category" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-pencil"></span></a><a class="button danger mini-button beautify" data-button="delete-category-button" data-var-id="' . $row['Category_ID'] . '" data-role="hint" data-hint="Delete Category" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-cross"></span></a></td>';
                                echo '</tr>';
                            }
