        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_holidays.php"><span class="mif-calendar icon"></span><span class="title">Manage Holidays</span></a></li>
            ...
            <div id="cell-content" class="cell auto-size padding20 pane-scroll">
                <h1 class="text-light">Manage Holidays</h1>
                <hr style="background-color:#493867;"><br>
                <div class="align-right">
                    <a class="button primary beautify beautify-mif" data-button="add-holiday-button" data-role="hint" data-hint="Add Holiday" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-plus"></span>&nbsp;&nbsp;Add</a>
                </div>
                <table id="holidays-table" class="table striped border bordered">
                    <thead>
                        <tr>
                            <th width="15%">Holiday ID</th>
                            <th>Holiday</th>
                            <th>Type</th>
                            <th>Date</th>
                            <th width="15%"></th>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $connection->fetch_assoc()) {
                                echo '<tr>';
                                echo '<td class="align-center">' . $row['Holiday_ID'] . '</td>';
                                echo '<td>' . $row['Holiday'] . '</td>';
                                echo '<td>' . $row['Holiday_Type'] . '</td>';
                                echo '<td>' . date('F d, Y', strtotime(sprintf('%04d-%02d-%02d', $row['Year'], $row['Month'], $row['Day']))) . '</td>';
                                echo '<td class="align-center"><a class="button success mini-button beautify" data-button="edit-holiday-button" data-var-id="' . $row['Holiday_ID'] . '" data-role="hint" data-hint="Edit Holiday" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-pencil"></span></a><a class="button danger mini-button beautify" data-button="delete-holiday-button" data-var-id="' . $row['Holiday_ID'] . '" data-role="hint" data-hint="Delete Holiday" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-cross"></span></a></td>';
                                echo '</tr>';
                            }
...
<script src="assets/js/manage_holidays.js"></script>
