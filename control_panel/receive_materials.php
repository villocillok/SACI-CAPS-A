        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./receive_materials.php"><span class="mif-enter icon"></span><span class="title">Returning</span></a></li>
                    <li class="divider"></li><li class="divider"></li>
            ...
            <div id="cell-content" class="cell auto-size padding20 pane-scroll"> <!--pane-scroll-->
                <h1 class="text-light">Return Books</h1>
                ...
                <div class="grid">
                    <div class="row cells12">
                        <div class="cell colspan10 offset1">
                            ...
                            <h3 class="text-light">Select book(s) to return</h3>
                            <hr style="background-color:#493867;"><br>
                            ...
                            <div class="align-right">
                                ...
                                <button class="button primary" data-button="return-button">Proceed</button>
                            </div>
                        </div>
                    </div>
                </div>
