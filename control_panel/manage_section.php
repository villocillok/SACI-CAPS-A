        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_section.php"><span class="mif-list2 icon"></span><span class="title">Manage Section</span></a></li>
                    <li class="divider"></li><li class="divider"></li>
            ...
            <div id="cell-content" class="pane-scroll cell auto-size padding20 pane-scroll">
                <h1 class="text-light">Manage Sections</h1>
                <hr style="background-color:#493867;"><br>
                <div class="align-right">
                    <a class="button primary beautify beautify-mif" data-button="add-section-button" data-role="hint" data-hint="Add Section" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-plus"></span>&nbsp;&nbsp;Add</a>
                </div>
                <table id="section-table" class="table striped border bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $connection->fetch_assoc()) {
                                echo '<tr>';
                                echo '<td class="align-center">' . $row['Section_ID'] . '</td>';
                                echo '<td>' . $row['Section_Type'] . '</td>';
                                echo '<td class="align-center"><a class="button success mini-button beautify" data-button="edit-section-button" data-var-id="' . $row['Section_ID'] . '" data-role="hint" data-hint="Edit Section" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-pencil"></span></a><a class="button danger mini-button beautify" data-button="delete-section-button" data-var-id="' . $row['Section_ID'] . '" data-role="hint" data-hint="Delete Section" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-cross"></span></a></td>';
                                echo '</tr>';
                            }
...
<script src="assets/js/manage_section.js"></script>
