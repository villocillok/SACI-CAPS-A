        ...
        <div class="row" style="height: 100%;">
            <div id="cell-sidebar" class="cell bg-lightDark size-x300" style="overflow-y: scroll; height: 100%;">
                <ul class="sidebar2 dark">
                    ...
                    <li class="active"><a href="./manage_publishers.php"><span class="mif-printer icon"></span><span class="title">Manage Publishers</span></a></li>
            ...
            <div id="cell-content" class="cell auto-size padding20 pane-scroll">
                <h1 class="text-light">Manage Publishers</h1>
                <hr style="background-color:#493867;"><br>
                <div class="align-right">
                    <a class="button primary beautify beautify-mif" data-button="add-publisher-button" data-role="hint" data-hint="Add Publisher" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-plus"></span>&nbsp;&nbsp;Add</a>
                </div>
                <table id="publishers-table" class="table striped border bordered">
                    <thead>
                        <tr>
                            <th width="15%">Publisher ID</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            while($row = $connection->fetch_assoc()) {
                                echo '<tr>';
                                echo '<td class="align-center">' . $row['Publisher_ID'] . '</td>';
                                echo '<td>' . $row['Publisher_Name'] . '</td>';
                                echo '<td>' . $row['Publisher_Address'] .'</td>';
                                echo '<td>' . $row['Contact_Number'] . '</td>';
                                echo '<td class="align-center"><a class="button success mini-button beautify" data-button="edit-publisher-button" data-var-id="' . $row['Publisher_ID'] . '" data-role="hint" data-hint="Edit Publisher" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-pencil"></span></a><a class="button danger mini-button beautify" data-button="delete-publisher-button" data-var-id="' . $row['Publisher_ID'] . '" data-role="hint" data-hint="Delete Publisher" data-hint-background="#dc4fad" data-hint-color="#ffffff" data-hint-mode="2" data-hint-position="top"><span class="mif mif-cross"></span></a></td>';
                                echo '</tr>';
                            }
...
<script src="assets/js/manage_publishers.js"></script>
